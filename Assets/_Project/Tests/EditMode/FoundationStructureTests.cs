...
namespace GlassRefrain.Tests.EditMode {
    public class FoundationStructureTests {
        ...
        public void CameraMovementBasisSnapshotIsReadOnly() {
            Assert.That(
                typeof(CameraMovementBasisSnapshot).IsDefined(
                    typeof(System.Runtime.CompilerServices.IsReadOnlyAttribute), false), Is.True);
        }

        [Test]
        public void DebugTransitionEventIsReadOnly() {
            Assert.That(
                typeof(DebugTransitionEvent).IsDefined(typeof(System.Runtime.CompilerServices.IsReadOnlyAttribute),
                    false), Is.True);
        }
    }
}